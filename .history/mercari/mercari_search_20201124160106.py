...
url = "https://www.mercari.com/jp/search/?page="+str(num)+"&keyword="+word
...
while True:
    if len(browser.find_element_by_css_selector()) > 0:
        ...
        for item_box in item_boxlist:
            try:
                ...
                print(e)
        btn = browser.find_element_by_css_selector().get_attribute('href')
